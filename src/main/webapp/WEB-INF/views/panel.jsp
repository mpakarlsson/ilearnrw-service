...
<c:if test="${edituser}">
	...
	<form action="panel" method="post">
		<input type="hidden" name="action" value="commit-user-edit"/>
		<input type="hidden" name="user_id" value="${user_id}"/>
		New user:<input type="text" name="username" value="${username}"/><br/>
...
<c:if test="${editrole}">
	...
	<form action="panel" method="post">
		<input type="hidden" name="action" value="commit-role-edit"/>
		<input type="hidden" name="role_id" value="${role_id}"/>
		New name:<input type="text" name="role_name" value="${role_name}"/><br/>
		<input type="submit" value="Save changes"/><br/>
	</form>
</c:if>
            ...
            <tr>
                ...
                <td>
                	<form action="panel" method="post">
	                	...
	                	<input type="hidden" name="role_id" value="${o.id}"/>
	                	<input type="submit" value="Edit"/>
                	</form>
                </td>
                <td>
...
<form action="panel" method="post">
	...
	Name:<input type="text" name="role_name"/><br/>
	<input type="submit" value="Submit"/>
</form>
</div>
...
<c:if test="${editpermission}">
	...
	<form action="panel" method="post">
		...
		New name:<input type="text" name="permission_name" value="${permission_name}"/><br/>
		<input type="submit" value="Save changes"/><br/>
	</form>
</c:if>
            ...
            <tr>
                ...
                <td>
                	<form action="panel" method="post">
	                	...
	                	<input type="hidden" name="permission_id" value="${o.id}"/>
	                	<input type="submit" value="Edit"/>
                	</form>
                </td>
                <td>
