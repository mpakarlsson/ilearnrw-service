...
<head>
    ...
    <script src="${pageContext.request.contextPath}/apps/resources/libs/sb-admin-v2/js/demo/dashboard-demo.js"></script>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <sec:authorize ifNotGranted="PERMISSION_TEACHER">
        			<h1 class="page-header">Normal Dashboard</h1>
    			</sec:authorize>
                </div>
                <!-- /.col-lg-12 -->
            </div>
